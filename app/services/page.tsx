...
export const metadata = {
  ...
  description: 'Services de développement web moderne à prix abordable. Création de sites web rapides, applications web et solutions e-commerce optimisées pour votre entreprise.',
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "description": "Développement d'applications web sur mesure avec des technologies modernes comme React et Next.js.",
                "provider": {
                  "@type": "ProfessionalService",
                  "name": "Web Wizardry",
                  "url": "https://webwizardry.fr"
              ...
              },
              {
                ...
                "description": "Création de boutiques en ligne performantes avec une expérience d'achat optimisée.",
                "provider": {
                  "@type": "ProfessionalService",
                  "name": "Web Wizardry",
                  "url": "https://webwizardry.fr"
        ...
        <div className="container mx-auto px-4 py-16">
          <StaggerContainer className="text-center mb-16">
            <h1 className="text-3xl md:text-4xl font-bold mb-4">
              Services de Développement Web Abordables et Rapides
            </h1>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Solutions web modernes et performantes adaptées à votre budget, avec des délais de livraison courts et garantis
            </p>
          </StaggerContainer>
